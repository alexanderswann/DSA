...
// function setup(){
      ...
      var client_id = '42f6854dd8ed4408a4ad3a7b52303250';
      var my_scopes =  '%2cugc-image-upload%2cuser-read-recently-played%2cuser-top-read%2cuser-read-playback-position%2cuser-read-playback-state%2cuser-modify-playback-state%2cuser-read-currently-playing%2capp-remote-control%2cstreaming%2cplaylist-modify-public%2cplaylist-modify-private%2cplaylist-read-private%2cplaylist-read-collaborative%2cuser-follow-modify%2cuser-follow-read%2cuser-library-modify%2cuser-library-read%2c';
      var redirect_uri = 'https://alexanderswann.github.io/DSA/';
    var   me = null;
    var   top = null;
    var   my_token = null;

    var login2 = select('#login');
  	login2.mousePressed(login);
//
...
//
    ...
    function login() {
      alert("hello");
      let popup = window.open('https://accounts.spotify.com/authorize?client_id=' +client_id + '&response_type=token&redirect_uri=' +redirect_uri+ '&scope=' + my_scopes + '&show_dialog=true', 'Login with Spotify', 'width=800,height=600');
